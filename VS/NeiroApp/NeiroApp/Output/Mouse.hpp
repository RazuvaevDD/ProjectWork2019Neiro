...
namespace Output_module
{
	...
	public:
		...
		void setCoords(double x, double y, double time); //Move cursor to x y coordinate in time (ms)
		void shiftCoords(double x, double y); //Shift cursor by x y
		void shiftCoords(double x, double y, double time); // Shift cursor by x y in time (ms)
